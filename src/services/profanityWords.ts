/**
 * Mirrors sttm-server `src/utils/profanityWords.js` and sttm-admin
 * `src/utils/profanityWords.ts`; keep the three in sync when adding words.
 *
...
export const EXACT = [...RUSSIAN_EXACT, ...UZBEK_EXACT, ...(leoEnglishDictionary as string[])];
