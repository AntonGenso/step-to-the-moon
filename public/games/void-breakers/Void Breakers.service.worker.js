...
/** @type {string} */
const CACHE_VERSION = '1771327340|191330848';
/** @type {string} */
const CACHE_PREFIX = 'Void Breakers-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Void Breakers.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Void Breakers.html","Void Breakers.js","Void Breakers.offline.html","Void Breakers.icon.png","Void Breakers.apple-touch-icon.png","Void Breakers.audio.worklet.js","Void Breakers.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Void Breakers.wasm","Void Breakers.pck"];
